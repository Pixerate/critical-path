...
- b8a68dd: Track task blocked duration while active in progress:
...
- 500b353: Standardize task blocker state on `isBlocked` as the single source of truth:
...
- c83235b: Add task execution timestamps and cumulative in-progress duration tracking:
