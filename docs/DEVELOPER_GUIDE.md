...
- `apps/docs` (`@critical-path/docs`): Astro + Starlight + Tailwind CSS documentation and marketing site deployed to Firebase App Hosting at `https://criticalpath.uchiage.app`.
